...
@Parcelize
data class SignupScreen(val platformNavigator: PlatformNavigator) : ParcelableScreen,
    KoinComponent {
    ...
    override fun Content() {
        ...
        SignUpView(authenticationPresenter, platformNavigator = platformNavigator, statesViewModel!!,
            profilePresenter, mainViewModel = mainViewModel!!, databaseBuilder = databaseBuilder)
    }


    @Composable
    fun SignUpView(authenticationPresenter: AuthenticationPresenter,
        ...
        val signUpInProgress = remember { mutableStateOf(false) }
        ...
        val authHandler = AuthenticationScreenHandler(authenticationPresenter,
            ...
            }, onCompleteEnded = { isSuccessful -> signUpInProgress.value = false },
            ...
            Column(modifier = rootModifier) {
                ...
                Column(modifier = topLayoutModifier) {
                    ...
                    Box(modifier = Modifier.fillMaxWidth().padding(start = 10.dp, end = 10.dp)) {
                        InputWidget(
                            iconRes = "drawable/email_icon.png",
                            maxLength = 100,
                            isSingleLine = true,
                            maxLines = 1,
                            text = email.value,
                            ...
                            email.value = it.toLowerCase(Locale.current)
                        }
                    }
                    Box(modifier = Modifier.fillMaxWidth().padding(start = 10.dp, end = 10.dp)) {
                        InputWidget(
                            iconRes = "drawable/password_icon.png",
                            maxLength = 100,
                            isSingleLine = true,
                            maxLines = 1,
                            text = password.value,

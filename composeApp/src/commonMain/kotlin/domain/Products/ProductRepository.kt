...
interface ProductRepository {
    ...
    suspend fun createOrder(vendorId: Long, userId: Long, deliveryMethod: String, paymentMethod: String, day: Int, month: Int, year: Int, orderItemJson: String, paymentAmount: Double): Single<ServerResponse>

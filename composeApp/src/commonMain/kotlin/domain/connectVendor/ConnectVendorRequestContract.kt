...
@Serializable
data class SearchVendorRequest(@SerialName("country") val country: String, @SerialName("city") val city: String, @SerialName("query") val query: String, @SerialName("connectedVendor") val connectedVendor: Long)
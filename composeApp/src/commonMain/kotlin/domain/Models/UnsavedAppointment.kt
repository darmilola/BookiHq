...
data class UnsavedAppointment(val bookingId: Int = -1, var isHomeService: Boolean = false, var serviceId: Int = -1,
                              ...
                              var appointmentDate: LocalDate? = null, val isRecommendedAppointment: Boolean = false,
                              var recommendationId: Int = -1, var serviceTypeSpecialist: ServiceTypeSpecialist? = null,

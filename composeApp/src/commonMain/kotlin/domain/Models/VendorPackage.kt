...
data class VendorPackage(@SerialName("id") val packageId: Long = -1, @SerialName("vendor_id") val vendorId: Long = -1,
                         ...
                         @SerialName("price") val price: Long = 0L, @SerialName("isMobileServiceAvailable") val isMobileServiceAvailable: Boolean = false,
                         @SerialName("mobileServicePrice") val mobileServicePrice: Long = 0L, @SerialName("therapists") val packageTherapists: ArrayList<PackageTherapists> = arrayListOf(),
